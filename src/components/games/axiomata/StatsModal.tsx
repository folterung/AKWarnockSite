      ...
      <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-md w-full mx-4 border-2 border-gray-100">
        ...
        <div className="flex gap-3">
          <div className="flex-1">
            <ShareCard onShareComplete={onClose} />
          </div>
          <button
            onClick={onClose}
            className="flex-1 px-6 py-3 bg-gradient-to-r from-gray-200 to-gray-300 text-gray-900 rounded-xl hover:from-gray-300 hover:to-gray-400 font-semibold transition-all duration-200 shadow-sm hover:shadow-md"
          >
            Close
          </button>
        </div>
