  ...
  return (
    <>
      ...
      <div className="pt-20 sm:pt-24 md:pt-28 px-4 sm:px-6 md:px-8 py-8 sm:py-10 md:py-12 pb-32 sm:pb-36 md:pb-40 max-w-3xl mx-auto">
        ...
        <section className="mt-8 sm:mt-10 md:mt-12">
          <h2 className="text-3xl font-bold text-center mb-4 sm:mb-5 md:mb-6">Steam</h2>
          <div className="space-y-4 sm:space-y-6 md:space-y-8">
            <Link
              href="/games/scratchytd"
              className="block border border-gray-300 rounded-lg p-4 sm:p-5 md:p-6 hover:bg-gray-100 transition group"
            >
              <div className="flex items-center gap-6">
                <div className="flex-shrink-0">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-600">
                    The cutest cats vs dogs tower defense game! Build towers, defend your turf, and battle adorable enemies.
                  </p>
                </div>
                <div className="flex-shrink-0">
                  <svg className="w-6 h-6 text-gray-400 group-hover:text-primary-600 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
